...
### Expo Quick Start (NSD-EXPO)
---
If you are at the National Science Day Expo, you can run the demonstration with a single click:
1. Double-click `run_demo.bat` in this folder.
2. The simulation will start with 20 people and optimized visualization settings.
